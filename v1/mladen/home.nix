...
let
  home-manager =
    "https://github.com/nix-community/home-manager/tarball/release-21.05";
  gui = config.services.xserver.enable;

in with lib; {
  imports = [ (import "${builtins.fetchTarball home-manager}/nixos") ];
  ...
  home-manager.users.mladen = {
    ...
    home = {
      sessionPath = [ "/home/mladen/dev/src/scripts/bin" ];
